...
class Collinsharper_Loomis_Block_Adminhtml_Loomismanifest_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    public function __construct() {
        parent::__construct();
        $this->setId('collinsharper_loomis_loomismanifest_grid');
    }
    ...
    {
        $collection = Mage::getModel('loomismodule/manifest')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('loomis_manifest_num', array(
            'header'    => Mage::helper('sales')->__('Loomis Manifest #'),
            'index'     => 'loomis_manifest_num',
            'filter_index'     => 'main_table.loomis_manifest_num',
            'type'      => 'text',
        ));
