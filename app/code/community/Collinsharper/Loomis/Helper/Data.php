...
class Collinsharper_Loomis_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
    ...
    {
        return Mage::getStoreConfig('carriers/loomismodule/' . $key);
    }

    public function getConfigFlag($key)
    {
        return Mage::getStoreConfigFlag('carriers/loomismodule/' . $key);
    }
    /**
    ...
    {
        return Mage::getSingleton('loomismodule/carrier_shippingmethod');
    }
    ...
    public function log($message)
    {
        ...
        if (Mage::getStoreConfig('carriers/loomismodule/debug')) {
    ...
    {
        $soapInterface = new Collinsharper_Loomis_Model_Soapinterface();
